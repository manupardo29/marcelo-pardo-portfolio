      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="order-1">
            ...
            <p className="mt-2 text-base font-medium text-primary-600 sm:mt-3 sm:text-lg lg:text-xl">
              {hero.roles}
            </p>

            <p className="mt-4 text-sm leading-relaxed text-slate-700 sm:mt-6 sm:text-base lg:text-lg">
              {hero.headline}
            </p>
